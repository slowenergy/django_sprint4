# Проверка статических страниц проекта
# Ключевые изменения после второго модуля:
# - Переход на Class-Based Views для статических страниц
# - Сохранение существующих URL-адресов
# - Обработка ошибок 403, 404, 500

def test_static_pages_as_cbv():
    """
    Проверяет использование CBV для статических страниц, что улучшает 
    масштабируемость проекта и упрощает обработку ошибок.
    """
    try:
